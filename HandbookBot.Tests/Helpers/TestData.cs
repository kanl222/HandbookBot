...
{
    public static Preparation CreatePreparation(int id, string name, decimal price, int pharmacyId, bool isAvailable = true)
        => new(id, name, price, pharmacyId, isAvailable);
    ...
    public static PreparationEntity CreatePreparationEntity(int id, string name, decimal price, int pharmacyId, bool isAvailable = true)
        => new() { Id = id, Name = name, Price = price, PharmacyId = pharmacyId, IsAvailable = isAvailable };
