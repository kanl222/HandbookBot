...
public sealed class InMemoryPreparationRepository : IPreparationRepository
{
    ...
    [
        new(1,  "Инсулин Хумулин М3 (картридж 3мл №5)",    1_290.00m, 1, true),
        new(2,  "Метформин 1000 мг №60 таб.",               312.50m,  1, true),
        new(3,  "Амлодипин 10 мг №30 таб.",                 248.00m,  2, true),
        new(4,  "Аторвастатин 40 мг №30 таб.",              390.00m,  2, true),
        new(5,  "Эналаприл 10 мг №20 таб.",                 145.00m,  3, true),
        new(6,  "Сальбутамол (ингалятор) 100 мкг/доза",     520.00m,  3, false),
        new(7,  "Варфарин 2.5 мг №50 таб.",                 198.00m,  1, true),
        new(8,  "Клопидогрел 75 мг №28 таб.",               650.00m,  2, false),
        new(9,  "Омепразол 20 мг №28 капс.",                 85.00m,  4, true),
        new(10, "Левотироксин натрия 50 мкг №50 таб.",      210.00m,  4, true),
    ];
